...
ROOT_URLCONF = "gamescal.urls"

# https://docs.djangoproject.com/en/dev/ref/settings/#wsgi-application
WSGI_APPLICATION = "gamescal.wsgi.application"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "gamescal.context_processors.build_info",
            ],
        },
    },
]
...
# Arizona remains on Mountain Standard Time year-round (no daylight saving time).
...
# Bootstrap-compatible message classes
